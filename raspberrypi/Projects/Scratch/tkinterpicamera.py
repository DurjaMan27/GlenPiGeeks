...
root.geometry("420x300+89+50")
root.title("Camera Button Test")

root.buttonframe = tk.Frame(root)
root.buttonframe.grid(row=5, column=4, columnspan=2)
...
tk.Button(root.buttonframe, text='Take Picture', command=CameraTakePic).grid(row=1, column = 4)
